...
$titleTextAlignment = get_sub_field($sepPrefix . '_title_font_alignment');
...
$introTextAlignment = get_sub_field($sepPrefix . '_intro_font_alignment');
...
$titlesTextAlignment = get_sub_field($sepPrefix . '_titles_font_alignment');
...
$contentTextAlignment = get_sub_field($sepPrefix . '_contents_font_alignment');
...
$textAlignment = get_sub_field('font_alignment');
...
$titleTextAlignmentG = get_field($sepPrefix . '_title_font_alignment');
...
$introTextAlignmentG = get_field($sepPrefix . '_intro_font_alignment');
...
$optionsTitleTextAlignment = get_field($sepPrefix . '_title_font_alignment', 'options');
...
$optionsContentTextAlignment = get_field($sepPrefix . '_contents_font_alignment', 'options');
...
$titleClass = textClass($sepPrefix, 'title', ['size', 'color', 'weight', 'alignment']);
