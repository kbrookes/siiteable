<?php
	...
	$title = textTitle($sepPrefix, $title);
	$intro = textTitle($sepPrefix, $intro);
	
	/// CONTAINER
	$containerClass = 'container';
	$containerClass = get_sub_field('container_size');
	
	$testimonialFontSize = 'text-md';
	$testimonialFontSize = get_sub_field('testimonial_font_size');
	
	$testimonialFontColor = 'text-dark';
	$testimonialFontColor = get_sub_field('testimonial_font_color');
	
	$citeFontSize = 'text-sm';
	$citeFontSize = get_sub_field('citation_font_size');
	
	$citeFontColor = 'text-dark';
	$citeFontColor = get_sub_field('citation_font_color');
	...
	<div class="testimonials-list">
		<section id="testimonialLoader-<?php echo $testimonial->ID;?>" class="testimonial-row testimonials-list__item flexi-inner">
			<div class="<?= $containerClass; ?>">
				...
				<h2 class="<?= $title; ?>"><?= get_sub_field('testimonial_block_title');?></h2>
				<? endif; ?>
						...
						<div class="post-item post-item__<?= $colDirection; ?>">
							<div class="testimonial-row__item">
								...
								<div class="testimonial-row__content">
									<blockquote class="<?= $testimonialFontSize . ' ' . $testimonialFontColor; ?>">
										<?php echo $testimonial_content; ?>
										<footer class="<?= $citeFontSize . ' ' . $citeFontColor; ?>">
